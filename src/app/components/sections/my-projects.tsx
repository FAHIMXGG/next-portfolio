...
export function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      id: 9,
      title: "CasePython",
      description: "Create custom phone cases with image upload, drag-and-drop, Stripe checkout, and order tracking.",
          ...
          {displayedProjects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                {imageLoading[project.id] !== false && <Skeleton className="w-full h-48 absolute inset-0 z-[9999]" />}
                <Image
