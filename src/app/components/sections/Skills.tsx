...
const Skills = () => {
  const skillsData = [
    ...
    {
      icon: <CircuitBoard className="text-cyan-400" />,
      name: "UI Libraries",
      animate: false,
    },
    {
      icon: <BsBootstrap className="text-purple-600" />,
      name: "Bootstrap",
      animate: false,
    },
    {
    ...
    {
      icon: <MdPhp className="text-purple-500" />,
      name: "PHP",
      animate: false,
    },
    {
  ...
  const toolsData = [
    ...
    {
      icon: <BiLogoDevTo className="text-gray-300" />,
      name: "Dev Tools",
      animate: false,
    },
    {
    ...
    {
      icon: <TbBrandVercel className="text-white" />,
      name: "Vercel",
      animate: false,
    },
    {
  ...
  const SkillCard = ({
    ...
    return animate ? (
      ...
      <div className="bg-[#131a2b] px-5 py-3  rounded shadow-sm shadow-[#1A9ED4]">
        <h1 className="font-bold flex items-center gap-2">
          {icon} {name}
        </h1>
      </div>
  ...
  return (
    <div className="bg-[#0F1729] py-16 lg:px-36 p-5" id="skill">
      ...
      <div className="flex items-center justify-center w-full mt-10">
        <div className="flex-grow border-t border-[#1A9ED4]"></div>
        <span className="mx-4 text-[#1A9ED4] font-bold text-2xl">Tools</span>
        <div className="flex-grow border-t border-[#1A9ED4]"></div>
      </div>
